...
public class LoginServlet extends HttpServlet {
     ...
     * @param req
     * @param resp
     * @description: 点击登录按钮进行登录认证，登录成功后将用户账号密码存入token中进行后续的令牌校验。
     * @return: void
     * @author CYQH
     ...
     * @param req
     * @param resp
     * @description: 每次进入Login-page页面时都会发送一个get请求，用以判断token是否存在，如果存在并且校验正确则进行自动登录，如果不存在或过期就提示请登录访问。
     * @return: void
     * @author CYQH
